...
select * from Interns 
where salary > ALL (select salary from Interns where dept=
'Kubernetes Developer' OR dept = 'Backend Engineer');

select * from Interns 
where salary > ANY (select salary from Interns where dept=
'Kubernetes Developer' OR dept = 'Backend Engineer');
